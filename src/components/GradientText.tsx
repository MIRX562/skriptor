...
export default function GradientText({
  ...
  return (
    <motion.span
      className={`relative inline-flex items-baseline font-medium transition-shadow duration-500 overflow-hidden cursor-pointer ${showBorder ? 'py-1 px-2' : ''} ${className}`}
