...
First item is the quarterly results. I'm happy to report that we've exceeded our targets by 12%.
  ...
  const transcription = {
    ...
    date: "May 10, 2023",
    duration: "45:12",
    status: "in_progress", // Change to "in_progress" to show the progress tracking
    progress: 68, // Add progress percentage
    mode: "medium", // Add transcription mode
    speakers: 3,
  };
            ...
            <TabsContent value="summary" className="space-y-4">
              <div className="border rounded-md p-4 h-[400px] overflow-y-auto">
                <div className="prose prose-sm dark:prose-invert max-w-none">
                  ...
                  <p>
                    The team meeting covered several key topics including
                    project updates, quarterly results, and upcoming deadlines.
                  </p>

                  <h4>Key Points:</h4>
                  <ul>
                    <li>
                      The Johnson project is on track with the first phase
                      completed
                    </li>
                  ...
                  <ul>
                    ...
                    <li>
                      Schedule follow-up meeting for marketing strategy (Owner:
                      Speaker 2)
                    </li>
                  </ul>
                </div>
