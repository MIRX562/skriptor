...
export const INITIAL_NODES: Node[] = [
  ...
  { id: "n-browser", type: "custom", position: { x: 50, y: 150 }, data: { label: "Client Layer", icon: Globe, type: "client", description: "React 19" } },
  { id: "n-s3", type: "custom", position: { x: 90, y: 260 }, data: { label: "Object Storage", icon: HardDrive, type: "storage", description: "Garage/MinIO" } },
  { id: "n-redis-queue", type: "custom", position: { x: 130, y: 370 }, data: { label: "Orchestration", icon: Zap, type: "queue", description: "BullMQ" } },
  { id: "n-postgres", type: "custom", position: { x: 170, y: 480 }, data: { label: "PostgreSQL", icon: Database, type: "db", description: "Persistence" } },
  
  // Column 2: Application Logic (Center - Center Aligned)
  { id: "p-api", type: "group", position: { x: 400, y: 130 }, data: { label: "Application Logic" }, style: { width: 360, height: 420 } },
  ...
  { id: "n-validator", parentId: "p-api", type: "custom", position: { x: 80, y: 180 }, data: { label: "Zod Validator", icon: Search, type: "server", description: "Payload" } },
  { id: "n-uploader", parentId: "p-api", type: "custom", position: { x: 80, y: 280 }, data: { label: "S3 Uploader", icon: FileUp, type: "server", description: "AWS SDK" } },

  // Column 3: AI Engine (Right - Center Aligned)
  { id: "p-worker", type: "group", position: { x: 850, y: 150 }, data: { label: "AI Engine" }, style: { width: 360, height: 380 } },
...
export const ALL_EDGES: Edge[] = [
  ...
  { id: "t-4", source: "n-uploader", target: "n-s3", sourceHandle: "left-out", targetHandle: "right-in", type: "packet", label: "Audio Put", data: { color: "#14b8a6" } },
  { id: "t-5", source: "n-uploader", target: "n-postgres", sourceHandle: "bottom-out", targetHandle: "top-in", type: "packet", label: "Insert Row", data: { color: "#14b8a6" } },
  { id: "t-6", source: "n-uploader", target: "n-redis-queue", sourceHandle: "right-out", targetHandle: "right-in", type: "packet", label: "Enqueue", data: { color: "#14b8a6" } },
  
  { id: "t-7", source: "n-redis-queue", target: "n-job-fetcher", sourceHandle: "right-out", targetHandle: "left-in", type: "packet", label: "Pop", data: { color: "#f97316" } },
  { id: "t-8", source: "n-job-fetcher", target: "n-s3", sourceHandle: "left-out", targetHandle: "right-in", type: "packet", label: "Fetch Audio", data: { color: "#ec4899" } },
  ...
  { id: "t-10", source: "n-whisper", target: "n-redis-queue", sourceHandle: "left-out", targetHandle: "right-in", type: "packet", label: "Progress", data: { color: "#ec4899" } },
  ...
  { id: "t-14", source: "n-callback", target: "n-auth-proxy", sourceHandle: "left-out", targetHandle: "right-in", type: "packet", label: "HTTP POST", data: { color: "#ec4899" } },
  { id: "t-15", source: "n-auth-proxy", target: "n-postgres", sourceHandle: "right-out", targetHandle: "top-in", type: "packet", label: "Update Result", data: { color: "#14b8a6" } },

  // Edit Flow
  { id: "e-1", source: "n-browser", target: "n-auth-proxy", sourceHandle: "right-out", targetHandle: "top-in", type: "packet", label: "PATCH Request", data: { color: "#3b82f6" } },
...
export const FLOWS = [
  {
    ...
    steps: [
      ...
      { id: "t-finish", title: "Result Verification", description: "Signed callback persisting data", edges: ["t-13", "t-14", "t-15"] },
    ]
  },
  {
    id: "edit",
